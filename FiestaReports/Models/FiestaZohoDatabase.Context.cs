...
namespace FiestaReports.Models
{
    ...
    public partial class FiestaZohoDatabaseEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetAllStates_Result> GetAllStates(Nullable<int> roleId, Nullable<int> loginId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllStates_Result>("GetAllStates", roleIdParameter, loginIdParameter);
        }
